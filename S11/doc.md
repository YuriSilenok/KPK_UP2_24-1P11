...
| speciality_id | Обязательно | Массив целых | минимум один элемент | — |
...
| speciality_id | Не обязательно | Массив целых | Каждый ID должен существовать в таблице Speciality | — |
...
Возвращает список всех специальностей. (это должно быть в других Таблицах)
