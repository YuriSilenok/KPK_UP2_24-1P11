...
erDiagram
    ...
    group ||--o{ curriculum : "group.id → curriculum.group_id"
    discipline ||--o{ curriculum : "discipline.id → curriculum.discipline_id"
    semester ||--o{ curriculum : "semester.id → curriculum.semester_id"