...
| Параметр (англ.) | Пояснение | Обязательность | Тип | Ограничение | Значение по умолчанию |
| :--- | :--- | :--- | :--- | :--- | :--- |
| semester | Номер семестра | Да | int | От 1 до 8, unique | — |
...
* **Важное ограничение**: Изменение параметров `group_id`, `discipline_id` и `semester_id` запрещено для сохранения целостности уникальной комбинации записи.
