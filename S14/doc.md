...
| `total_hours` | Общая нагрузка за семестр (округлено до 2 знаков) | float |

**Примечание:** Поле `is_active` при создании всегда устанавливается в `true`, но не возвращается в ответе.
