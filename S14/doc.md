...
| `limit` | Максимальное количество записей в ответе (по умолчанию 100, диапазон 1-1000) | Нет | int |
| `offset` | Количество пропущенных записей для пагинации (по умолчанию 0) | Нет | int |
