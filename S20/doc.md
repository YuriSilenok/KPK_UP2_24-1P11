...
| name_contains | Поиск по части имени | Строка | 1-100 символов |
| parent_period_id | Фильтр по родительскому периоду | Целое | 0 – корневые (семестры), либо ID существующего семестра |
