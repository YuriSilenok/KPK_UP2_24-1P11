...
| parent_period_id | Необязательно | Целое | NULL – для семестра, ID семестра – для модуля | NULL |
...
| parent_period_id | Необязательно | Целое | NULL – для семестра, ID семестра – для модуля | – |
...
| parent_period_id | Целое | Фильтр по родительскому периоду (NULL – корневые) |
