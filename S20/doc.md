...
|----------|-----|-----------|
| result | Логический | True, если учебный период успешно деактивирован (установлен `is_active = False`). False, если период с указанным ID не найден или уже деактивирован. |

> **Примечание:** удаление логическое (soft delete). Запись не удаляется физически, устанавливается `is_active = False`. Сервис не входит в список исключений (Auth/Role/Permission) для физического удаления.
