...
|----------|-----------|-----|-------------|
| academic_year | Фильтр по учебному году | Строка | Формат ГГГГ-ГГГГ |
| period_type | Тип периода | Строка | semester, module |
| name_contains | Поиск по части имени | Строка | Любая строка, не более 100 символов |
| parent_period_id | Фильтр по родительскому периоду | Целое | 0 или ID существующего семестра |
