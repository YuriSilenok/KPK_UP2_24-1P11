...
| date | Нет | date | Конкретная дата (для праздников) | — |
| start_date | Нет | date | Дата начала (для каникул) | — |
| end_date | Нет | date | Дата окончания (для каникул) >= start_date | — |
| type | Да | string | "holiday" или "vacation" | — |
