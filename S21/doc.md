...
Устанавливает поле is_active в False для Holiday с указанным ID. Вернет True, если запись была обновлена, иначе вернет False.
...
Устанавливает поле is_active в False для VacationPeriod с указанным ID. Вернет True, если запись была обновлена, иначе вернет False.
...
Устанавливает поле is_active в False для HolidayType с указанным ID. Вернет True, если запись была обновлена, иначе вернет False.
