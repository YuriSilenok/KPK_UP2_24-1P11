...
|----------|----------------|-----|-------------|-----------------------|
| `name` | Да | str | длина от 3 до 255 символов, уникально | — |
| `phone` | Нет | str | формат `+7XXXXXXXXXX` (12 символов)  | `''` (пустая строка) |
...
| Параметр | Обязательность | Тип | Ограничение | Значение по умолчанию |
|----------|----------------|-----|-------------|-----------------------|
| `name` | Нет | str | длина от 3 до 255 символов, уникально (кроме самого себя) | текущее значение |
| `phone` | Нет | str | формат `+7XXXXXXXXXX` (12 символов)  | текущее значение |
