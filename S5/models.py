...
class Department(Model):
    ...
    name = CharField(max_length=100, unique=True, null=True, verbose_name="Название отделения")
    phone = CharField(max_length=20, unique=True, null=True, verbose_name="Телефон")
